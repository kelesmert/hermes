...
- Monitoring servisi ve frontend’i 1/6/12/24 saatlik dinamik telemetry pencerelerini destekliyor; ayrıca `/api/board/machines/:id/trend` endpoint’i üzerinden son 7 güne ait saatlik ortalama sıcaklık/tork/enerji ve uptime yüzdesi hesaplanarak Trend kartında gösteriliyor.
