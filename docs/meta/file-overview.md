...
- `backend/src/domains/simulations/services/simulation-clock-service.js`: Shift-sim sanal takvimini yönetir (epoch date, resume, next-day), `getShiftSimNow` ile sim-clock timestamp üretir ve `shift-sim` reset işlemini uygular.
