...
- `frontend/src/features/ai/pages/ai-hub.jsx`: AI Asistanı hub sayfası; U1/U2/U3 kartları, KPI kartları (son 7 gün analiz, son analiz zamanı, kapsanan makine sayısı), filtreli analiz tablosu, 7 gün özeti, 200/20 sayfalama, on-demand stale kontrolü ve “Kullanım İstatistikleri (Yakında)” placeholder bölümünü gösterir.
