...
- `backend/src/domains/ai/`: AI domain’i; OpenAI client wrapper, insight/usage modelleri, U1 OEE Insight servisleri ve `/api/ai/*` endpoint’lerini içerir. U1 kullanımı için cache, rate limit ve stale kontrolü sağlar.
