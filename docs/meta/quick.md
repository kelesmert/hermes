...
- `npm run data:gen` komutu yeni `scripts/data-gen.js` script’ini çalıştırır; interval değerleri `.env` üzerinden (`DATA_GEN_INTERVAL_MS`, `DATA_GEN_MACHINE_REFRESH_MS`) konfigüre edilebilir.
