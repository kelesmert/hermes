...
- [x] Dashboard operasyon görünümü görsel zenginleştirme (KPI kartları, durum dağılımı grafiği, arama alanları) + `paused` job için UI statü düzeltmesi + machine code fallback
